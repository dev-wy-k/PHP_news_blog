<div class="col-12 col-lg-3 col-xl-2 sidebar vh-100">
                <div class="d-flex justify-content-between align-items-center py-2 mt-3 nav-brand">
                    <div class="">
                        <span class="bg-primary p-2 pt-3 rounded mr-2">
                            <i class="feather-shopping-bag text-white ml-1 h4"></i>
                        </span>
                        <span class="font-weight-bold text-primary h4 text-uppercase">My Shop</span>
                    </div>
                ...
                <div class="nav-menu">
                    <ul>
                        ...
                        <li class="menu-item text-center">  
                            <a href="<?php echo $url ; ?>/logout.php" class="btn btn-outline-danger w-75">
